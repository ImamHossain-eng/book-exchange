...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="/admin/cashin/request" class="w3-bar-item w3-button">Cash-In Requests</a>
  <a href="/admin/cashout/request" class="w3-bar-item w3-button">Cash-Out Requests</a>
